 ...
 * If the AbstractAccountAuthenticator needs to use an activity to handle the
 * request then it can
 * have the activity extend AccountAuthenticatorActivity. The
 * AbstractAccountAuthenticator passes
...
public abstract class AccountAuthenticatorActivity extends ThemedActivity {
     ...
     * this
     * Activity to be launched. If result is null or this method is never called
     * then
