...
- [ ] **Task 1.2:** Replace lossy & thread-unsafe `MaterialisticDatabase` LiveData event bus with `SharedFlow` (`[ARCH-10]`)
- [ ] **Task 1.3:** Guard `FontCache.java` asset loading against uncaught exceptions and migrate to `res/font/` (`[ARCH-15]`)
